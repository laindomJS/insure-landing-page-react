...
export const NavbarContainer = () => {
  ...
  return (
    <nav className='w-full lg:w-4/5 flex items-center justify-between mx-auto py-4 md:py-8 px-4 md:px-0 relative'>
      ...
      <ul ref={menu} className='absolute top-16 left-0 md:top-0 md:left-0 bg-[#2A2B32] bg-nav-pattern-mobile bg-no-repeat bg-bottom md:bg-transparent md:static w-full min-h-screen md:min-h-fit md:w-fit flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8 list-none font-karla pt-12 md:pt-0 transition-transform duration-300 translate-y-full md:translate-y-0'>
